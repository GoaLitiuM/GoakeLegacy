...
extern cvar_t sv_maxvelocity, sv_wallfriction, sv_jumpvelocity, sv_maxairspeed, sv_strafeaccelerate, sv_aircontrol, sv_airstopaccelerate, sv_movementstyle, sv_jumpboost, sv_maxairstrafespeed, pm_jumpfix, pm_airstep, pm_slidyslopes, pm_slidefix, sv_stepheight, sv_autojump, sv_extrajumps;
...
//			statsf[STAT_MOVEVARS_WALLFRICTION]					= 0;
	...
	statsf[STAT_MOVEVARS_EXTRAJUMPS]					= sv_extrajumps.value;
#endif
