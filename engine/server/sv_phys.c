...
cvar_t	pm_airstep			 = CVARFD("pm_airstep", "", CVAR_SERVERINFO, "Allows players to step up while jumping. This makes stairs more graceful but also increases potential jump heights. Value of 3 enables stair jumping where first step up eats all vertical velocity.");
