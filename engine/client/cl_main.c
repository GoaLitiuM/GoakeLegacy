...
cvar_t	cfg_save_name = CVARFD("cfg_save_name", GAME_CFGFILE, CVAR_ARCHIVE|CVAR_NOTFROMSERVER, "This is the config name that is saved by default when no argument is specified.");
